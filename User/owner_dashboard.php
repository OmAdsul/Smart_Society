...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            ...
            <span class="navbar-text ms-auto me-3">Welcome, <?php echo htmlspecialchars($user['name']); ?> (Owner)</span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info-card">
                        ...
                        <p><strong>Ownership Status:</strong> <?php echo $flat['ownership_status']; ?></p>
                    </div>
                </div>
